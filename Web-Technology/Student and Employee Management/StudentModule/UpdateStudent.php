...
<head>
    ...
    <link rel="shortcut icon" href="https://img.icons8.com/cute-clipart/64/000000/e.png" type="image/x-icon">
        ...
        if(isset($_SESSION['addUpdate'])){?>
            <div class="alertAdd" id="disable">
                ...
                <p>     
                    <?php
                        if(isset($_SESSION['addUpdate'])){
                            echo $_SESSION['addUpdate'];
                            unset($_SESSION['addUpdate']);
                        }
                    ?>
                </p>
            </div>
...
<form action="" method="post" class="form-control" id="form">
       <table>
            <tr>
                ...
                <td><input name="rollno" id="RollNo" class="input" type="number" value="<?php echo $row['rollNo'];?>" readonly></td>
            </tr>
            <tr>
                <td><label class="label">Name  :</label></td>
                <td><input name="name" id="name" class="input" type="text" pattern="[a-zA-Z ]{4,24}" onkeyup="nameValidate()" value="<?php echo $row['studName'];?>" required></td>
            </tr>
            ...
            <tr>
                <td><label class="label">Subject I  :</label></td>
                <td><input name="subjectOne" min="1" max="100" id="SubjectOne" class="input" type="number" value="<?php echo $row['subjectOne'];?>" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject II  :</label></td>
                <td><input name="subjectTwo" min="1" max="100" id="SubjectTwo" class="input" type="number" value="<?php echo $row['subjectTwo'];?>" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject III  :</label></td>
                <td><input name="subjectThree" min="1" max="100" id="subjectThree" class="input" type="number" value="<?php echo $row['subjectThree'];?>" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject IV  :</label></td>
                <td><input name="subjectFour" min="1" max="100" id="SubjectFour" class="input" type="number" value="<?php echo $row['subjectFour'];?>" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject V  :</label></td>
                <td><input name="subjectFive" min="1" max="100" id="SubjectFive" class="input" type="number" value="<?php echo $row['subjectFive'];?>" required></td>
            </tr>
            <tr></tr><tr><br></tr>
            <tr>
                <td><input type="submit" value="Submit" name="submit" class="submit-btn" onclick="reSet();"></td>
                <td></td>
...
<?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "UPDATE marks SET studName = '$name', subjectOne = '$subjectOne', subjectTwo = '$subjectTwo', subjectThree = '$subjectThree', subjectFour = '$subjectFour', subjectFive = '$subjectFive' WHERE rollNo = '$rollno'";
