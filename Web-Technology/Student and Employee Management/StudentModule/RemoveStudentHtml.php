...
<?php
    ...
    <h3>Do you wish to delete the data of the above Student??</h3>.
        <table>
            <tr>
                <td><a href="RemoveStudent.php?id= <?php echo $row['rollNo'];?>" class="submit-btn">Yes</a></td>
                <td><a href="RemoveStudent.php?id= <?php echo 0;?>" class="reset-btn" style="margin-left: 195px;">No</a></td>
            </tr>
        </table>
    </div>
    </form>
