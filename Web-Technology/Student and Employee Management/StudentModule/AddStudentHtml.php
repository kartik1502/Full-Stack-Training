...
<body>
  ...
  <path fill-rule="evenodd" d="M12,23 C5.92486775,23 1,18.0751322 1,12 C1,5.92486775 5.92486775,1 12,1 C18.0751322,1 23,5.92486775 23,12 C23,18.0751322 18.0751322,23 12,23 Z M12,21 C16.9705627,21 21,16.9705627 21,12 C21,7.02943725 16.9705627,3 12,3 C7.02943725,3 3,7.02943725 3,12 C3,16.9705627 7.02943725,21 12,21 Z M12,13.4142136 L8.70710678,16.7071068 L7.29289322,15.2928932 L10.5857864,12 L7.29289322,8.70710678 L8.70710678,7.29289322 L12,10.5857864 L15.2928932,7.29289322 L16.7071068,8.70710678 L13.4142136,12 L16.7071068,15.2928932 L15.2928932,16.7071068 L12,13.4142136 Z"/>
    ...
    <?php } ?>
    <form action="AddStudent.php" method="post" class="form-control">
       <table>
            <tr>
            ...
            <tr>
                ...
                <td><input name="name" id="name" class="input" type="text" pattern="[a-zA-Z ]{4,24}" onkeyup="nameValidate()" required></td>
            </tr>
            ...
            <tr>
                ...
                <td><input name="subjectOne" min="1" max="100" id="SubjectOne" class="input" type="number" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject II  :</label></td>
                <td><input name="subjectTwo" min="1" max="100" id="SubjectTwo" class="input" type="number" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject III  :</label></td>
                <td><input name="subjectThree" min="1" max="100" id="subjectThree" class="input" type="number" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject IV  :</label></td>
                <td><input name="subjectFour" min="1" max="100" id="SubjectFour" class="input" type="number" required></td>
            </tr>
            <tr>
                <td><label class="label">Subject V  :</label></td>
                <td><input name="subjectFive" min="1" max="100" id="SubjectFive" class="input" type="number" required></td>
            </tr>
            <tr></tr><tr><br></tr>
            <tr>
