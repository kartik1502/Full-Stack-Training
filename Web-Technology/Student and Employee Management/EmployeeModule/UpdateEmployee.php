...
<form action="" method="post" class="form-control" id="form">
       <table>
            <tr>
                ...
                <td><input name="empId" id="RollNo" class="input" type="number" value="<?php echo $row['empId'];?>" readonly></td>
            </tr>
            <tr>
                <td><label class="label">Employee Name:</label></td>
                <td><input name="empName" id="name" class="input" type="text" pattern="[a-zA-Z ]{4,24}" value="<?php echo $row['empName'];?>" required></td>
            </tr>
            ...
            <tr>
                ...
                <td><input name="baseSalary" min="1" id="baseSalary" class="input" type="number" value="<?php echo $row['baseSalary'];?>" required></td>
            </tr>
            <tr></tr><tr><br></tr>
            <tr>
...
<?php
            ...
            header('Location: UpdateEmployeeHtml.php');
        }
        include "Employeeconnection.php";
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "UPDATE worker SET empName = '$empName', baseSalary = '$baseSalary' WHERE empId = '$empId'";
